...
parser.add_argument('--save_dir', type=str, default='./lyft_scene_flow', help='path to save .npz file')
parser.add_argument('--root_path', type=str, default='./data/Lyft', help='root path for lyft raw data')
