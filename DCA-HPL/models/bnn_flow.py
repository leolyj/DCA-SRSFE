...
class BilateralCorrelationFlex(nn.Module):
    ...
    def forward(self, feat1, feat2, prev_corr_feat,
        ...
        for cidx in range(num_chunks):
            ...
            spread_out1 = splatted1[batch_indices[:, None, None, None].clone(),
                                    self.feat1_indices[None, :, None, None].clone(),
                                    (pc1_corr_indices + 1)[:, None, :, start:end].clone()]
            ...
            spread_out2 = splatted2[batch_indices[:, None, None, None, None].clone(),
                                    self.feat_indices[None, :, None, None, None].clone(),
                                    (pc2_corr_indices + 1)[:, None, :, :, start:end].clone()]
