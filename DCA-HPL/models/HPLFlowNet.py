...
class HPLFlowNet(nn.Module):
    ...
    def forward(self, pc1, pc2, generated_data):
        ...
        # print('corr_out1', corr_out1.shape)
        ...
        # print('corr_out2', corr_out2.shape)
        ...
        # print('corr_out3', corr_out3.shape)
        ...
        # print('corr_out4', corr_out4.shape)
        ...
        # print('corr_out5', corr_out5.shape)
        # upsample
