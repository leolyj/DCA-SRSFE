...
def augmentation(pc):
    ...
    #                          0.01)  # 0.005  0.01
    angle = np.random.uniform(-0.01, 0.01)  # (0.0349 ~ 2 deg)
    # angle = 0
...
class KITTI_target(data.Dataset):
    """
    Args:
    ...
    def __init__(self,
        ...
        self.root = osp.join(args.data_root_target, 'KITTI_processed_occ_final')
    ...
    def __getitem__(self, index):
        ...
        pc1_transformed, pc2_transformed, sf_transformed = self.transform([pc2_loaded, pc1_loaded])
        ...
        return pc1, pc2, generated_data, pc1_2, pc2_2, generated_data_target_2, self.samples[index], sf
    ...
    def make_dataset(self):
        ...
        res_paths = 120 * useful_paths  # repeat target dataset to fit the scale of source dataset
