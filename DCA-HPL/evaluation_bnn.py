...
def evaluate(val_loader, model, logger, args):
    ...
    with torch.no_grad():
        for i, items in enumerate(val_loader):
            ...
            # print(pc1_np.shape)
            # ply_pc1 = '/media/asus/bff416fa-b0ca-4c6a-b793-de319cc5ad0b/jz/HPLFlowNet/lyft_ply/ours/' + str(i) + '_pc1.ply'
            # write_ply(ply_pc1, np.squeeze(pc1_np), ['x', 'y', 'z'])
            # ply_pc2 = '/media/asus/bff416fa-b0ca-4c6a-b793-de319cc5ad0b/jz/HPLFlowNet/lyft_ply/ours/' + str(i) + '_pc2.ply'
            # write_ply(ply_pc2, np.squeeze(pc2_np), ['x', 'y', 'z'])
            # ply_gt = '/media/asus/bff416fa-b0ca-4c6a-b793-de319cc5ad0b/jz/HPLFlowNet/lyft_ply/ours/' + str(i) + '_gt.ply'
            # write_ply(ply_gt, np.squeeze(pc1_np + sf_np), ['x', 'y', 'z'])

            # ply_pred = '/media/asus/bff416fa-b0ca-4c6a-b793-de319cc5ad0b/jz/HPLFlowNet/lyft_ply/ours_ft3d/' + str(i) + '_pred.ply'
            # write_ply(ply_pred, np.squeeze(pc1_np + output_np), ['x', 'y', 'z'])
            # print(ply_pred)
            # print('ply file saved.')
            EPE3D, acc3d_strict, acc3d_relax, outlier = evaluate_3d(output_np, sf_np)
            # print(i, EPE3D, acc3d_strict, acc3d_relax, outlier)
    ...
    with torch.no_grad():
        for i, items in enumerate(val_loader):
            ...
            # if i < 10:
                print(i, path)
                print('EPE3D ', EPE3D)
                ply_pc1 = '/media/asus/bff416fa-b0ca-4c6a-b793-de319cc5ad0b/jz/HPLFlowNet/saved_ply/' + str(i) + '_pc1.ply'
                write_ply(ply_pc1, np.squeeze(pc1_np), ['x', 'y', 'z'])
                ply_pc2 = '/media/asus/bff416fa-b0ca-4c6a-b793-de319cc5ad0b/jz/HPLFlowNet/saved_ply/' + str(i) + '_pc2.ply'
                write_ply(ply_pc2, np.squeeze(pc2_np), ['x', 'y', 'z'])
                ply_gt = '/media/asus/bff416fa-b0ca-4c6a-b793-de319cc5ad0b/jz/HPLFlowNet/saved_ply/' + str(i) + '_gt.ply'
                write_ply(ply_gt, np.squeeze(pc1_np + sf_np), ['x', 'y', 'z'])
                ply_pred = '/media/asus/bff416fa-b0ca-4c6a-b793-de319cc5ad0b/jz/HPLFlowNet/saved_ply/' + str(i) + '_pred.ply'
                write_ply(ply_pred, np.squeeze(pc1_np + output_np), ['x', 'y', 'z'])
                ply_pred_t = '/media/asus/bff416fa-b0ca-4c6a-b793-de319cc5ad0b/jz/HPLFlowNet/saved_ply/' + str(i) + '_predt.ply'
                write_ply(ply_pred_t, np.squeeze(pc1_np + output_t_np), ['x', 'y', 'z'])
                print('ply file saved.')
