...
class SceneflowDataset():
    def __init__(self, root_path='', npoints=16384, train=False):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--root_path', type=str, default='./data/waymo', help='root path of waymo')
    args = parser.parse_args()

    root_path = args.root_path

    sf_dataset = SceneflowDataset(root_path=root_path, train=True)  # train
    sf_dataset.convert_waymo_data()

    sf_dataset = SceneflowDataset(root_path=root_path, train=False)  # valid
    sf_dataset.convert_waymo_data()
